<template>
  <div>
    <div class="flex items-center mb-6">
      <div class="w-12 h-12 bg-beige/30 rounded-full flex items-center justify-center mr-3">
        <User class="h-6 w-6 text-charcoal/70" />
      </div>
      <div>
        <h2 class="text-lg font-medium text-charcoal">{{ user.fullName }}</h2>
        <p class="text-sm text-charcoal/60">Member since {{ user.memberSince }}</p>
      </div>
    </div>
    ...
    <nav class="space-y-1">
      <button 
        ...
        :class="activeTab === 'profile' ? 'bg-beige/20 text-charcoal font-medium' : 'text-charcoal/70 hover:bg-beige/10 hover:text-charcoal'"
      >
      ...
      <button 
        ...
        class="w-full flex items-center px-3 py-2 text-sm rounded-sm transition-colors"
        :class="activeTab === 'orders' ? 'bg-beige/20 text-charcoal font-medium' : 'text-charcoal/70 hover:bg-beige/10 hover:text-charcoal'"
      >
