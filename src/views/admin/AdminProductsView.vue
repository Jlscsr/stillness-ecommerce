  ...
  <div class="p-6">
    <div class="flex justify-between items-center mb-6">
      ...
      <router-link to="/admin/products/add">
        <button class="bg-sage hover:bg-sage/90 text-white px-4 py-2 rounded-md flex items-center">
        ...
        <div class="rounded-md border overflow-hidden">
          <table class="min-w-full divide-y divide-charcoal/10">
            <thead class="bg-cream">
              <tr>
                <th class="px-4 py-3 text-left text-xs font-medium text-charcoal/70 uppercase tracking-wider">
                  Image
                </th>
                <th
            ...
            <tbody class="bg-white divide-y divide-charcoal/10">
              ...
              >
                <td class="px-4 py-4 whitespace-nowrap">
                  <div class="h-10 w-10 overflow-hidden rounded-sm bg-cream">
                    <img
                ...
                <td class="px-4 py-4 whitespace-nowrap">
                  <div>
                    ...
                    <div v-if="product.japaneseText" class="text-xs text-charcoal/60">
                      {{ product.japaneseText }}
                    </div>
                  </div>
                </td>
                <td class="px-4 py-4 whitespace-nowrap">
                  <span class="inline-flex items-center px-2 py-1 rounded-full bg-beige/20 text-charcoal text-xs">
                    {{ product.category }}
                  </span>
                </td>
                <td class="px-4 py-4 whitespace-nowrap">${{ product.price.toFixed(2) }}</td>
                ...
                <td class="px-4 py-4 whitespace-nowrap text-right">
                  <div class="relative">
                    <button
                      @click="toggleActionDropdown(product.id)"
                    ...
                    <div
                      v-if="activeActionDropdown === product.id"
    ...
    <div v-if="deleteDialogOpen" class="fixed inset-0 z-50 overflow-y-auto">
      <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        <div class="fixed inset-0 transition-opacity" @click="deleteDialogOpen = false">
          ...
          <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div class="sm:flex sm:items-start">
              <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                <h3 class="text-lg leading-6 font-medium text-charcoal">Delete Product</h3>
                <div class="mt-2">
            ...
            <div v-if="productToDelete" class="mt-4 flex items-center space-x-4">
...
const confirmDelete = () => {
  if (productToDelete.value) {
    // Here we would normally call an API to delete the product
...
watch(
  ...
  () => {
    ...
    if (searchQuery.value) {
      ...
      result = result.filter(
        (product) =>
          ...
          (product.japaneseText && product.japaneseText.toLowerCase().includes(query))
      );
    }
    ...
    result = result.sort((a, b) => {
      ...
      if (sortField.value === 'name' && typeof aValue === 'string' && typeof bValue === 'string') {
  ...
  return [
    {
      ...
      japaneseText: "陶器のお茶セット",
      price: 89.99,
      description: "Traditional ceramic tea set with natural glaze finish",
      category: "Dining",
      inStock: true,
      images: [
        { id: 1, src: "/images/products/tea-set-1.jpg", alt: "Ceramic Tea Set" }
      ]
    },
    {
      id: "prod-002",
      name: "Linen Pillow Covers",
      japaneseText: "リネン枕カバー",
      price: 35.50,
      description: "Pure linen pillow covers in earthy tones",
      category: "Home",
      inStock: true,
      images: [
        { id: 1, src: "/images/products/pillow-1.jpg", alt: "Linen Pillow Covers" }
      ]
    },
    {
      id: "prod-003",
      ...
      inStock: false,
      images: [
        { id: 1, src: "/images/products/matcha-1.jpg", alt: "Matcha Tea Powder" }
      ]
    },
    {
      id: "prod-004",
      name: "Linen Kimono Robe",
      japaneseText: "リネン着物ローブ",
      price: 79.99,
      description: "Comfortable everyday kimono-style robe in pure linen",
      category: "Apparel",
      inStock: true,
      images: [
        { id: 1, src: "/images/products/kimono-1.jpg", alt: "Linen Kimono Robe" }
      ]
    },
    {
      id: "prod-005",
      ...
      japaneseText: "竹のお香立て",
      price: 24.50,
      description: "Minimalist bamboo incense holder for stick incense",
      category: "Decor",
      inStock: true,
      images: [
        { id: 1, src: "/images/products/incense-1.jpg", alt: "Bamboo Incense Holder" }
      ]
    },
    {
      id: "prod-006",
      name: "Aromatic Bath Salts",
      japaneseText: "アロマバスソルト",
      price: 18.99,
      description: "Natural bath salts with lavender and hinoki cypress",
      category: "Wellness",
      inStock: true,
      images: [
        { id: 1, src: "/images/products/bath-salts-1.jpg", alt: "Aromatic Bath Salts" }
      ]
    }
  ];
}
